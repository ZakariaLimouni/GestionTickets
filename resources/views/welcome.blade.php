...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-white  dark:text-black/50" style="position:fixed">
        <div class="bg-gray-50 text-black/50 dark:bg-white dark:text-black/50">
            @if (Route::has('login'))
            <nav class="-mx-3 flex flex-1 justify-end " style="background-color: #fff">
                @auth
